    ...
    <swiper-slide class="common-slide" :class="slideCls">
        <div class="wrap" :style="{ height : wrapHeight+'rem', 'margin-top' : -(wrapHeight/2+1.5)+'rem' }">
            ...
            <template v-if="slideObj.category=='new-tech'"><!-- 闪亮新人 -->
                <div class="info-wrap tech-info opacity-ani ani" :style="{'margin-top' : 0.7+marginRem*0.3+'rem'}">
            ...
            <template v-if="slideObj.category=='health'"><!-- 养身频道-->
                <div class="info-wrap ani" v-html="slideObj.content" ref="healthContent" @touchmove="doTouchMoveContent($event)"></div>
            </template>
            <template v-if="slideObj.category=='actDesc'"><!--活动文字-->
                <div class="info-wrap ani" v-html="slideObj.content" ref="actDescContent" @touchmove="doTouchMoveContent($event)"></div>
